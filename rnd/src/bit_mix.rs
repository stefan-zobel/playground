...
mod bit_mix_tests {
    ...
    fn test_rrxmrrxmsx() {
        ...
        println!("l4: {}", l4);
        println!("l5: {}", l5);
        assert_eq!(l1, -1074278017023486638);
        assert_eq!(l2, 791467320547438801);
        assert_eq!(l3, -6237844429596446841);
        assert_eq!(l4, 967439720212533408);
        assert_eq!(l5, 4511633004553689581);
    }
}
